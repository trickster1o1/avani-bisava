    ...
    subCategory: [
      {
        ...
        childCategory: [
          ...
          {
            childCategoryName: "shampoos",
            value: "shampoos",
          },
          {
            childCategoryName: "hair conditioners",
            value: "hair_conditioners",
          },
          {
            childCategoryName: "natural hair colour",
            value: "natural_hair_colour",
          },
        ],
      },
      {
...
export const singleCategoryData = [
  {
    ...
    subCategory: [
      {
        childCategory: [
          ...
          {
            childCategoryName: "Handmade bathing bars",
            value: "handmade_bathing_bars",
          },
          {
            childCategoryName: "Ubtan",
            value: "ubtan",
          },
        ],
      },
    ...
    subCategory: [
      {
        childCategory: [
          ...
          {
            childCategoryName: "E-Gift-Cards",
            value: "e_gift_cards",
          },
        ],
      },
